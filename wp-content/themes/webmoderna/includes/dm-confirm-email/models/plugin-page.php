        ...
        foreach($valid as $k => $v) {
            ...
            if(strlen($v) == 0) {
                add_settings_error(
                    $k,
                    $k . '_texterror',
                    __( 'Por favor ingresá un válido ', 'emyth' ) . $k,
                    'error'
                );
            }
        }
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                ...
                <h2 class="nav-tab-wrapper">
                    <a href="#" class="nav-tab nav-tab-active" id="dmec-general"><?php _e('Contenido del E-Mail', 'emyth');?></a>
                    <a href="#" class="nav-tab" id="dmec-email">Email Welcome Message <?php _e('Mensaje de bienvenida del email.', 'emyth');?></a>
                    <a href="#" class="nav-tab" id="dmec-email-reg">Email Registration Message <?php _e('Mensaje de Registración del E-Mail', 'emyth');?></a>
                    <a href="#" class="nav-tab" id="dmec-settings">Notification Messages <?php _e('Mensajes de Notificación', 'emyth');?></a>
                </h2>
                ...
                <div id="dmec-general-div" class="dmec-div" style="display: inline">
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    <?php _e('Asunto del e-mail a enviar.');?>
                                </p>
                            </td>
                        </tr>
                        <!-- Confirm Email Text -->
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <?php _e("Enviar un mensaje como HTML?", "emyth");?>
                            </th>
                            <td>
                ...
                <div id="dmec-email-div" class="dmec-div">
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <?php _e("Send Welcome Message?", "emyth");?>
                            </th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <?php _e("Welcome Email Subject", "emyth");?>
                            </th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <?php _e("Welcome email message", "emyth");?>
                            </th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <?php _e("Send Welcome Message as HTML?", "emyth");?>
                            </th>
                            <td>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">
                                    ...
                                    <?php _e('Sobreescribir el asunto del e-mail.', 'emyth');?>
                                </p>
                            </td>
                        </tr>
                ...
                <div id="dmec-settings-div" class="dmec-div">
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <?php _e("Success registration message", "emyth");?>
                            </th>
                            <td>
